...
const TourCard = ({
  ...
  return (
    <div className="cursor-pointer group relative flex flex-col my-6 bg-white shadow-md border border-slate-200 rounded-lg w-96 hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="px-4">
        ...
        <div className="flex flex-col w-3/5 font-normal text-slate-600">
